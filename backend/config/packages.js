...
// All prices set to $1 for testing - Update in production
// This file controls all subscription packages and limits
...
module.exports = {
  ...
  parent: {
    basic: {
      ...
      stripeProductId: "prod_parent_basic", // Will be created in Stripe
      stripePriceId: "price_parent_basic_monthly", // Will be created in Stripe
      limits: {
        children: 2
      },
      features: [
